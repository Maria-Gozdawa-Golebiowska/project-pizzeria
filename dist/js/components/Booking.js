    ...
    thisBooking.dom.tables.forEach(table => {
      table.addEventListener('click', function (event) {
        ...
        if (clickedElement.classList.contains('table')) {
          ...
          if (thisBooking.booked.hasOwnProperty(thisBooking.datePicker.value)
              && thisBooking.booked[thisBooking.datePicker.value].hasOwnProperty(thisBooking.hourPicker.value)
              && thisBooking.booked[thisBooking.datePicker.value][thisBooking.hourPicker.value].includes(parseInt(tableId))) {
